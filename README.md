...
As of writing this on Feb 2023, new ideas for usability and better Python are brewing. Current goal is allowing the end-user to configure task properties dynamically without re-inventing database schema on business logic changes.
