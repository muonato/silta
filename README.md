...
As of writing this on Feb 2023, new ideas for usability and better Python emerge on a daily basis. Current goal is allowing the end-user to configure task properties dynamically, without re-inventing database schema when altering the business logic.
