...
As of writing this on Feb 2023 the project is evolving as new ideas for usability and better Python solutions emerge. Current goal is to facilitate any new task configuration for the end-user without re-inventing the database model.
